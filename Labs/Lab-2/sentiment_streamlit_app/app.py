...
This app loads a saved scikit-learn Pipeline from model.pkl and uses it
...
# Constants
# ---------------------------------------------------------------------------
MODEL_FILE: Final[Path] = Path("model.pkl")
...
def load_model(model_path: Path) -> Pipeline:
    ...
    ------
    FileNotFoundError
        If model.pkl has not been created yet.
    """
...
def predict_sentiment(model: Pipeline, text: str) -> tuple[str, pd.DataFrame]:
    ...
    ----------
    model:
        Trained scikit-learn Pipeline loaded from model.pkl.
    text:
...
def main() -> None:
    ...
    with st.expander("How this app works"):
        st.write(
            ...
            "4. The trained pipeline is saved as `model.pkl`.\n"
